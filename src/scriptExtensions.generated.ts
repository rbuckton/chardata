...
export const Bopo = Object.freeze(CharSet.fromStartLengthArray([12289,2,12296,9,12307,8,12316,3,12330,3,12336,0,12343,0,12350,1,12539,0,12736,35,12832,35,12928,48,12992,11,13144,24,13179,4,13280,30,65093,1,65377,4]));
...
export const Hang = Object.freeze(CharSet.fromStartLengthArray([12289,2,12296,9,12307,8,12316,3,12336,0,12343,0,12350,1,12539,0,12736,35,12832,35,12928,48,12992,11,13144,24,13179,4,13280,30,65093,1,65377,4]));
export { Hang as Hangul };
export const Hani = Object.freeze(CharSet.fromStartLengthArray([12289,2,12294,0,12296,9,12307,8,12316,3,12330,3,12336,0,12343,0,12348,3,12539,0,12688,15,12736,35,12832,35,12928,48,12992,11,13144,24,13179,4,13280,30,65093,1,65377,4]));
export { Hani as Han };
export const Hano = Object.freeze(CharSet.fromStartLengthArray([5941,1]));
export { Hano as Hanunoo };
export const Hira = Object.freeze(CharSet.fromStartLengthArray([12289,2,12294,0,12296,9,12307,8,12316,3,12336,5,12343,0,12348,3,12441,3,12448,0,12539,1,12688,15,12736,35,12832,35,12928,48,12992,11,13144,24,13179,4,13280,30,65093,1,65377,4,65392,0,65438,1]));
export { Hira as Hiragana };
export const Kana = Object.freeze(CharSet.fromStartLengthArray([12289,2,12294,0,12296,9,12307,8,12316,3,12336,5,12343,0,12348,3,12441,3,12448,0,12539,1,12688,15,12736,35,12832,35,12928,48,12992,11,13144,24,13179,4,13280,30,65093,1,65377,4,65392,0,65438,1]));
