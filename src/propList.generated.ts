...
export const AHex = Object.freeze(CharSet.fromStartLengthArray([48,9,65,5,97,5]));
export { AHex as ASCII_Hex_Digit };
export const Bidi_C = Object.freeze(CharSet.fromStartLengthArray([8206,1,8234,4]));
...
export const SD = Object.freeze(CharSet.fromStartLengthArray([105,1,303,0,585,0,616,0,669,0,690,0,1011,0,1110,0,1112,0,7522,0,7574,0,7588,0,7592,0,7725,0,7883,0,8305,0,8520,1,11388,0,119842,1,119894,1,119946,1,119998,1,120050,1,120102,1,120154,1,120206,1,120258,1,120310,1,120362,1,120414,1,120466,1]));
export { SD as Soft_Dotted };
export const Term = Object.freeze(CharSet.fromStartLengthArray([33,0,44,0,46,0,58,1,63,0,894,0,903,0,1417,0,1475,0,1548,0,1563,0,1567,0,1748,0,1792,10,1804,0,2040,1,2096,14,2142,0,2404,1,3674,1,3848,0,3853,5,4170,1,4961,7,5741,1,5867,2,6100,2,6106,0,6146,3,6152,1,6468,1,6824,3,7002,1,7005,2,7227,4,7294,1,8252,1,8263,2,11822,0,12289,1,42238,1,42509,2,42739,4,43126,1,43214,1,43311,0,43463,2,43613,2,43743,0,43760,1,44011,0,65104,2,65108,3,65281,0,65292,0,65294,0,65306,1,65311,0,65377,0,65380,0,66463,0,66512,0,67671,0,67871,0,68410,5,69703,6,69822,3,69953,2,70085,1,74864,3]));
export { Term as Terminal_Punctuation };
export const UIdeo = Object.freeze(CharSet.fromStartLengthArray([13312,6581,19968,20940,64014,1,64017,0,64019,1,64031,0,64033,0,64035,1,64039,2,131072,42710,173824,4148,177984,221]));
export { UIdeo as Unified_Ideograph };
export const VS = Object.freeze(CharSet.fromStartLengthArray([6155,2,65024,15,917760,239]));
export { VS as Variation_Selector };
export const WSpace = Object.freeze(CharSet.fromStartLengthArray([9,4,32,0,133,0,160,0,5760,0,6158,0,8192,10,8232,1,8239,0,8287,0,12288,0]));
